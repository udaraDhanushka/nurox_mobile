...
import { User, Shield, FileText, LogOut, Lock, Camera, Sun, Moon, Package, Building, Settings, Globe } from 'lucide-react-native';
  ...
  const menuItems = [
    {
      ...
      onPress: () => router.push('/(pharmacist)/profile/personal'),
    },
    {
      title: t('language'),
    ...
    },
    {
      ...
      onPress: () => router.push('/(pharmacist)/profile/license'),
    },
    {
      title: t('pharmacyAffiliations'),
      icon: <Building size={24} color={isDarkMode ? COLORS.white : COLORS.primary} />,
      onPress: () => router.push('/(pharmacist)/profile/affiliations'),
    },
    {
      title: t('inventoryPreferences'),
      icon: <Package size={24} color={isDarkMode ? COLORS.white : COLORS.primary} />,
      onPress: () => router.push('/(pharmacist)/profile/inventory-settings'),
    },
    {
      title: t('professionalSettings'),
      icon: <Settings size={24} color={isDarkMode ? COLORS.white : COLORS.primary} />,
      onPress: () => router.push('/(pharmacist)/profile/settings'),
    },
    {
      title: t('privacyPolicy'),
      icon: <Lock size={24} color={isDarkMode ? COLORS.white : COLORS.primary} />,
      onPress: () => router.push('/(pharmacist)/profile/privacy'),
    },
    {
      title: t('helpSupport'),
      icon: <FileText size={24} color={isDarkMode ? COLORS.white : COLORS.primary} />,
      onPress: () => router.push('/(pharmacist)/profile/support'),
    },
  ];
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileHeader}>
          ...
          <View style={styles.professionalInfo}>
            <Text style={[styles.specialization, isDarkMode && styles.textSecondaryDark]}>Licensed Pharmacist</Text>
            <Text style={[styles.pharmacy, isDarkMode && styles.textSecondaryDark]}>HealthCare Pharmacy</Text>
          </View>
        </View>
