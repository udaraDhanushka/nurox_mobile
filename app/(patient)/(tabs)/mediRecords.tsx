  ...
  const recordCategories = [
    {
      ...
      route: '/(patient)/records/prescriptions'
    },
    {
      id: 'lab-reports',
      title: 'Lab Reports',
      ...
      route: '/(patient)/records/lab-reports'
    },
    {
      id: 'medical-history',
      ...
      route: '/(patient)/records/medical-history'
    },
    {
      id: 'vitals',
      title: 'Vital Signs',
    ...
    },
    {
      ...
      route: '/(patient)/records/allergies'
    },
    {
      id: 'documents',
      ...
      route: '/(patient)/records/documents'
    }
  ];
